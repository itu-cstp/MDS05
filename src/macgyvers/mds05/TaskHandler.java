...
import macgyvers.mds05.xml.Cal;
import macgyvers.mds05.xml.CalSerializer;
...
public class TaskHandler {
	...
	private TaskHandler(){
		//deserialize the calendar of events
	...
	public boolean roleMatches(String taskId, String role){
		...
		ArrayList<String> roles = task.roles; 
		String[] array = roles.get(0).split(", ");
		for(String r : array)
		{
		...
		public void start(){
			...
			while(true){
				...
				if(!notExecuted.isEmpty()){
					...
					//if it has conditions, check whether they're fulfilled.
